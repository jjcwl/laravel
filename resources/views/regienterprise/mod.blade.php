...
<div class="col-md-6 col-xs-12">
    ...
    enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="col-md-9 col-sm-9 col-xs-12">
            <input type="text" class="form-control"  placeholder="请输入企业名称" name="enter_name" value="{{$list->enter_name}}">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">营业执照：
            </label>
            <div class="col-md-9 col-sm-9 col-xs-12">
            @foreach($photo as $p)
