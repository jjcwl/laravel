...
<div class="col-md-6 col-xs-12">
    ...
    enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="col-md-9 col-sm-9 col-xs-12">
            <input type="text" class="form-control"  placeholder="请输入用户名称" name="username">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">身份证正面：</label>
            <div class="col-md-9 col-sm-9 col-xs-12">
            <input type="file" multiple name="id_photo[]">
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">身份证反面：</label>
            <div class="col-md-9 col-sm-9 col-xs-12">
