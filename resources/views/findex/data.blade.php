...
<div class="logo container-fluid">
	<div class="logoimg col-md-3 col-md-offset-1" style="padding-left: 0">
...
<div class="col-md-12 col-xs-12" style="padding-top: 20px;" >
    ...
    enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label class="control-label col-md-2 col-sm-3 col-xs-12 col-md-offset-3">企业名称：</label>
        ...
        <div class="form-group">
            <label class="control-label col-md-2 col-sm-3 col-xs-12 col-md-offset-3">合作金额：</label>
            <div class="col-md-3 col-sm-9 col-xs-12">
        ...
        <div class="form-group">
            <label class="control-label col-md-2 col-sm-3 col-xs-12 col-md-offset-3">企业项目：</label>
            <div class="col-md-3 col-sm-9 col-xs-12">
            <input type="text" class="form-control"  placeholder="请输入企业项目" name="en_project">
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-md-2 col-sm-3 col-xs-12 col-md-offset-3">企业logo：</label>
            <div class="col-md-3 col-sm-9 col-xs-12">
            <input type="file" name="logo[]">
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-md-2 col-sm-3 col-xs-12 col-md-offset-3">企业简介：</label>
