    ...
    <div class="table-responsive">
        ...
        <tbody>
            ...
            <tr class="even pointer">
                ...
                <td>{{$v->author}}</td>
                <td>{{$v->describe}}</td>
                <td> <a href="{{url('article/mod')}}?id={{$v->id}}"><i class="fa fa-edit"></i> <span class="nav-label">编辑</span> </a>
                <a href="{{url('article/del')}}?id={{$v->id}}"><i class="fa fa-bank"></i> <span class="nav-label">删除</span> </a></td>
